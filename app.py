...
with st.container():
    ...
    ######
    ###### Choose your stock and time interval for prediction and metrics in the next time
    ...
    ###### up, static (no change) down. It does not predict what the price will be exactly
    ###### 
    """)
