...
with st.container():
    ...
    ######
    ###### Choose your stock and time interval for predictions and metrics in the next time
    ###### interval, when selected the timestamp is the current time
    ######
    ###### For example, if 5m (5 minutes) is chosen say at 10:14am EST, then the model will  
    ###### predict the movement direction of the stock in the 5m time interval between
    ###### 10:15am and 10:20am
    ######
    ###### NOTE: the model predicts what the stock will likely do in the next time interval:
    ###### up, static (no change), or down. It does not predict what the price will be exactly
    ###### 
    """)
